            ...
            controller: [ '$scope', function($scope) {
                ...
                $scope.loadPDF = function(path) {
                    ...
                    PDFJS.getDocument(path, null, null, $scope.documentProgress).then(function(_pdfDoc) {
                        ...
                        $scope.numPages = $scope.pdfDoc.numPages;
                        if($scope.displayAll == "true"){
                            $scope.pdfDoc.getPage($scope.pageNum).then($scope.renderAll)
                        }else{
                ...
                $scope.renderAll=function(page){
                    $scope.renderPage($scope.pageNum);
                    //Move to next page
                    $scope.pageNum++;
                    if ( $scope.pdfDoc !== null && $scope.pageNum <= $scope.numPages )
                    {
                        $scope.pdfDoc.getPage( $scope.pageNum ).then( $scope.renderAll );
                    }
                };
